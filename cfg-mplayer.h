...
//---------------------- libao/libvo options ------------------------
    ...
    OPT_CHOICE("color-primaries", requested_color_primaries, 0,
               ({"auto", MP_CPRIM_AUTO},
                {"BT.470BG", MP_CPRIM_BT_470BG}, {"pal", MP_CPRIM_BT_470BG},
                {"BT.709", MP_CPRIM_BT_709}, {"hd", MP_CPRIM_BT_709},
                {"SMPTE-170M", MP_CPRIM_SMPTE_170M}, {"ntsc", MP_CPRIM_SMPTE_170M})),
    ...
    OPT_CHOICE("colormatrix-output-range", requested_output_range, 0,
               ({"auto", MP_CSP_LEVELS_AUTO},
                {"limited", MP_CSP_LEVELS_TV},
                {"full", MP_CSP_LEVELS_PC})),
    OPT_CHOICE("chroma-sample-location", requested_chroma_sample_location, 0,
               ({"auto", MP_CHROMA_LOC_AUTO},
                {"left", MP_CHROMA_LOC_LEFT},
                {"center", MP_CHROMA_LOC_CENTER},
                {"top-left", MP_CHROMA_LOC_TOP_LEFT},
                {"top", MP_CHROMA_LOC_TOP},
                {"bottom-left", MP_CHROMA_LOC_BOTTOM_LEFT},
                {"bottom", MP_CHROMA_LOC_BOTTOM})),
