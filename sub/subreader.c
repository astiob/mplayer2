...
/*
   ...
   subtitle at time, previous_sub_end is used to communicate the end of the
   previous subtitle from the code reading the next. The previous subtitle
   is then modified to have the correct end time.
 */
